...
public class TampilanBola extends javax.swing.JFrame {
    ...
    private void cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariActionPerformed
        ...
        for (int i = 0; i < lenght; i++) {
            if (DaftarBola[i].getId().equalsIgnoreCase(search) || DaftarBola[i].getNama().equalsIgnoreCase(search) || DaftarBola[i].getDiameter().equalsIgnoreCase(search)) {
                areafind.append("ID Bola\t : " + DaftarBola[i].getId() + "\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilanBola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilanBola().setVisible(true);
            }
        });
    }
